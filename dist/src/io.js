        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!!fs_1.existsSync(path_1.resolve(dataPath(folder), gzFilename))) return [3 /*break*/, 2];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, ungzip(path_1.resolve(dataPath(folder), gzFilename), path_1.resolve(dataPath(folder), filename))];
                case 3:
                    _a.sent();
...
function ungzip(fromFile, toFile) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    readStream = fs_1.createReadStream(dataPath(fromFile));
                    writeStream = fs_1.createWriteStream(dataPath(toFile));
                    return [4 /*yield*/, util_1.promisify(stream_1.pipeline)(readStream, zlib_1.createGunzip(), writeStream)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
