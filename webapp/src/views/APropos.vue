<template>
  <div>
    ...
    <ul>
      ...
      <li>Logo de chaînes TV issus de <a href="https://fr.wikipedia.org">Wikipédia</a>, reproduits ici en vertu des droits accordés par les articles L711-1 et suivants du Code de la propriété intellectuelle.</li>
    </ul>
  </div>
